...
--   * configuraciones ERP ACTIVAS (las credenciales se copian cifradas, sin
--     mostrarlas ni descifrarlas);
...
--
-- IMPORTANTE: las ERPs activas apuntaran al MISMO SAP que las empresas origen.
-- Consultar datos es aislado a nivel Qoncilia, pero procesar BankPages, depositos
-- de tarjetas, conciliaciones externas o borrados puede escribir en SAP real.
-- Ejecutar esos flujos exclusivamente contra un SAP de pruebas.
--
...
-- Copia todas las ERPs activas, manteniendo codigo, queries y valores cifrados.
...
JOIN public.empresas_erp_configuraciones source_config
 ...
 AND source_config.epc_activo = TRUE;
